    ...
    <div class="corpo_princ" style="margin-top: 130px; background-color: #F5F5DC; width: 1100px; max-height: 910px; margin-left: 10%;" >   
        ...
        <div class="corpo_sec" style="width: 950px; padding-top: 20px; margin-left: 70px;" > 
          ...
          <form method="POST" action="../../../conexoes/conexao_clientes.php" name="form_clientes">
              ...
              <h5 style="text-align: left; margin-bottom: 10px; border-bottom: 0.5px solid #B9B9B9;">ALTERAR CLIENTES</h5>

              <div class="form-row">
                  <div class="form-group col-md-1">
                    <label for="id_cliente">Id_Cliente</label>
                    <input type="text" class="form-control" id="id_cliente"  name="id_cliente" value="<?php echo $id_cliente;?>" disabled>
              ...
              <div class="form-row">             
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control" id="nasc" name="dat_nasc" value="<?php echo $dat_nasc;?>" required>
                  </div>              
              </div>
               ...
               <div class="form-row"> 
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control" id="dat_rg" name="dat_rg" value="<?php echo $data_rg;?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="orgao_rg">Órg Exp</label>
                    <input type="text" class="form-control" id="orgao_rg" name="orgao_rg" value="<?php echo $org_rg;?>" required>
                  </div>
              ...
              <div class="form-row">  
                <div class="form-group col-md-2">
                  ...
                  <input type="text" onchange="get_endereco(document.form_clientes.cep.value)" class="form-control" id="cep" name="cep" value="<?php echo $cep;?>" required>
                </div>
                <div class="form-group col-md-8">
                  <label for="endereco">Endereço</label>
                  <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo $end;?>" required>
                </div>
                 <div class="form-group col-md-2">
                  <label for="num_end">Nº</label>
                  <input type="text" class="form-control" id="num_end" name="num_end" value="<?php echo $num_end;?>" required>
                </div>
              </div>    
              ...
              <div class="form-row">  
                <div class="form-group col-md-5">
                  ...
                  <input type="text" class="form-control" id="compl" name="compl_end" value="<?php echo $compl;?>" required>
                </div>
                 <div class="form-group col-md-3">
              ...
              <div class="form-row"> 
                <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" id="cel1" name="cel1" value="<?php echo $cel1;?>" required>
                </div>
                <div class="form-group col-md-2">
                  <label for="cel2">Celular(2)</label>
                  <input type="text" class="form-control" id="cel2" name="cel2" value="<?php echo $cel2;?>" >
                </div>
                <div class="form-group col-md-8">
              ...
              <div class="form-row" style="margin-left: 0px; margin-top: 20px; margin-bottom: 20px; padding-top: 20px; padding-bottom: 20px; border-top: 0.5px solid #B9B9B9; border-bottom: 0.5px solid #B9B9B9;  "> 
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="corretor" name="corretor" value="<?php echo $corretor;?>">
                </div>
                <div class="form-group col-md-3">
                  <label for="cel1_corretor">Celular(1)</label>
                  <input type="text" class="form-control" id="cel1_corretor" name="cel1_corretor" value="<?php echo $cel1_corretor;?>">
                </div>
                <div class="form-group col-md-3">
                  <label for="cel2_corretor">Celular(2)</label>
                  <input type="text" class="form-control" id="cel2_corretor" name="cel2_corretor" value="<?php echo $cel2_corretor;?>">
                </div>                
              </div> 
              ...
              <div class="form-row">  
                ...
                <div class="form-group col-md-9">
                  ...
                  <input type="text" class="form-control" id="obra" name="obra" value="<?php echo $obra;?>">
                </div>
                <div class="form-group col-md-3">
                    <label for="situacao">Situação</label>
                    <select class="custom-select mr-sm-2" id="situacao" name="situacao" required>
              ...
              <input type="hidden" name="cliente_interno" value="alt">
