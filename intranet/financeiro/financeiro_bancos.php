...
<body >
  ...
  <div style="margin-top: 60px; margin-left: 650px; "><h3>BANCOS</h3></div>

  
      
<div style="width: 100%; position: absolute; margin-top: -10px; height: 700px; ">
      ...
      <div style="position: relative; float: left; margin-top: 20px; margin-left: 20px; background-color: #F5F5DC; width: 950px; max-height: 700px;">             
              ...
              <div class="container" style="width: 931px; font-size: 9pt; margin-top: 30px; height: 800px;  ">     
                    ...
                    <div class="container-fluid" style="background-color: #1C1C1C; padding: 5px; color: white; height: 65px;">
                       ...
                       <div class="" style="margin-top: 10px; margin-left: 270px; margin-right: 30px; position: relative; float: left;" >
               ...
               <style type="text/css">
                 ...
                 #extrato .scrollContainer{width: 899px; height: 500px; overflow: auto;}
                 #extrato table {width:900px; border: 0px margin: 0px;}
          ...
          <div class="container" style="position: relative; float: left;  margin-top: 20px; margin-left: 5px; width: 100px; height: 800px; ">

              <h5 style="margin-left: 25px; font-weight: bold; ">Links</h5>
                    
              <a href="http://www.caixa.gov.br/Paginas/home-caixa.aspx" target="_blank"><img style="width: 100px; height: 50px; margin-bottom: 15px;" src="../../img/caixa.jpg"></a>                    
    
              <a href="https://www.bb.com.br/pbb/pagina-inicial#/" target="_blank"><img style="width: 100px; height: 50px;" src="../../img/bb.png"></a>         
