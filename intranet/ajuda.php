...
<body>
      ...
      <div><h3 style="text-align: center; margin-top: 80px;">AJUDA</h3></div>
      <div style="width: 100%; position: absolute; margin-top: 0px; height: 700px; ">
          ...
          <div style="position: relative; float: left;  margin-top: 20px; margin-left: 15px; width: 250px;  ">
            <nav style="height: 600px; " class="navbar bg-dark" >
                <ul class="menu_lat_esq1">
                  <li><a class="menu_lat_esq_a" href="#">Como criar uma lista do CHECK LIST?</a></li>
                  <li><a class="menu_lat_esq_a" href="#">Financeiro</a>
                  		<ul>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma conta bancária?</a></li>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma conta bancária?</a></li>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma conta bancária?</a></li>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma conta bancária?</a></li>
                  		</ul>			
    			  </li>
                  <li><a class="menu_lat_esq_a" href="#">Operacional</a>
                  		<ul>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma obra?</a></li>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma obra?</a></li>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma obra?</a></li>
                  			<li><a class="menu_lat_esq_a" href="#">Como cadastrar uma obra?</a></li>
                  		</ul>			
          ...
          <div style="position: relative; float: left; margin-top: 20px; margin-left: 40px; background-color: #F5F5DC; width: 1150px; height: 600px;">
