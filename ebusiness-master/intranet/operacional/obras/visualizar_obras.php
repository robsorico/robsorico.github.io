          ...
          <form method="POST" action="../../../conexoes/conexao_obras.php" >
              ...
              <div class="form-row">
                  <div class="form-group col-md-1">
                    ...
                    <input type="text" class="form-control" id="obra"  name="obra" value="<?php echo $nu_obra?>" disabled>
                  </div>
                  ...
                  <div class="form-group col-md-9">
                    <label for="end">Endereço Completo</label>
                        ...
                        { ?>
                          <select class="custom-select mr-sm-2" id="end" name="end" value="<?php echo $id_imoveis?>" disabled>
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <select class="custom-select mr-sm-2" id="status_obra" name="status_obra" value="<?php echo $txt_status_obra?>" disabled>
              ...
              <div class="form-row" > 
                <div class="form-group col-md-3">
                  ...
                  <input type="date" class="form-control" id="dat_inic" name="dat_inic" value="<?php echo $dat_inic?>" disabled>
                </div>    
                <div class="form-group col-md-3">
                  <label for="dat_fim">Data Fim</label>
                  <input type="date" class="form-control" id="dat_fim" name="dat_fim" value="<?php echo $dat_fim?>" disabled>
                </div> 
                <div class="form-group col-md-1">
                  <label for="qdte">Qtde</label>
                  <input type="text" class="form-control" id="qtde" name="qtde" value="<?php echo $qtde_imoveis?>" disabled>
                </div>
                <div class="form-group col-md-2">
                  <label for="tipo">Tipo</label>
                  <input type="text" class="form-control" id="tipo" name="tipo" value="<?php echo $tipo_imoveis?>" disabled>
                </div>
              </div>
              ...
              <h5 style="text-align: left; margin-top: 20px; margin-bottom: 10px; border-bottom: 0.5px solid #B9B9B9;">RECEITA FEDERAL - DISO</h5>  
               ...
               <div class="form-row" > 
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="cnpj_obra" name="cnpj_obra" value="<?php echo $nu_insc_cnpj?>" disabled>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="dat_ent_cnpj">DATA ENTRADA</label>
                    <input type="date" class="form-control" id="dat_ent_cnpj" name="dat_ent_cnpj" value="<?php echo $dat_ent_cnpj?>" disabled>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="dat_fim_cnpj">DATA FIM</label>
                    <input type="date" class="form-control" id="dat_fim_cnpj" name="dat_fim_cnpj" value="<?php echo $dat_fim_cnpj?>" disabled>
                  </div>                              
              </div>
              <div class="form-row" > 
                  <div class="form-group col-md-3">
                    <label for="cei_obra">CADASTRO - CEI</label>
                    <input type="text" class="form-control" id="cei_obra" name="cei_obra" value="<?php echo $nu_insc_cei?>" disabled>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="dat_ent_cei">DATA ENTRADA</label>
                    <input type="date" class="form-control" id="dat_ent_cei" name="dat_ent_cei" value="<?php echo $dat_ent_cei?>" disabled>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="dat_fim_cei">DATA FIM</label>
                    <input type="date" class="form-control" id="dat_fim_cei" name="dat_fim_cei" value="<?php echo $dat_fim_cei?>" disabled>
                  </div>                              
              </div>
               ...
               <div class="form-row" > 
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" id="nu_alvara" name="nu_alvara" value="<?php echo $nu_alvara?>" disabled>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="dat_alvara">Data Alvará</label>
                    <input type="date" class="form-control" id="dat_alvara" name="dat_alvara" value="<?php echo $dat_alvara?>" disabled>
                  </div>
                  <div class="form-group col-md-5">
                    <label for="autor_proj">Autor do Projeto</label>
                    <input type="text" class="form-control" id="autor_proj" name="autor_proj" value="<?php echo $txt_autor_proj?>" disabled>
                  </div> 
                  <div class="form-group col-md-2">
                    <label for="crea_alvara">CREA</label>
                    <input type="text" class="form-control" id="crea_alvara" name="crea_alvara" value="<?php echo $nu_crea?>" disabled>
                  </div>                 
              </div> 
                     
        </div><br>

              <input type="hidden" name="id_obras" value="$id_obras">
